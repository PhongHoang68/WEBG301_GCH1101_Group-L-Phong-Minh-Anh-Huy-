                        ...
                        <div class="column cell wild-encounter__container__text">
                            <div class="wysiwyg container-medium pad-2-horizontal -column">
                                ...
                                <p>Get up-close and personal with some of your favorite animals like penguins, cheetahs, porcupines, and sloths.</p>
                                                                    <p><a href="<?php echo e(route('customer.singleProduct')); ?>"><span class="btn-fill-tiger">Book Now</span></a></p>
                            </div>
...
<?php echo $__env->make('masters.customerMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Last-Zoo\resources\views/Zoo/CustomerView/customerView.blade.php ENDPATH**/ ?>